...
from nq_utils import predict_answer, compute_f1, sanitize_query, tokenizer, device, model  # Added model import
...
for split in splits_to_try:
    try:
        ...
        ds = load_dataset(hf_nq_ds, split=split).select(range(10000))  # Limit to 10000 records for testing
