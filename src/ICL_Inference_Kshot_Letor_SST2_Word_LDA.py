# ICL LeToR inference for 12 handcrafted + 16 LDA features
...
df = pd.read_csv("/kaggle/input/top50-sbert-precompute/test_query_top50_with_LDA_features.csv")
...
def run_kshot_letor_inference(order="desc"):
    # Use the models trained with only 28 features (12 + 16 LDA)
    model_path = "/kaggle/input/trained-models/lambdamart_with_LDA_features_asc.txt" if order == "asc" else "/kaggle/input/trained-models/lambdamart_with_LDA_features_desc.txt"
