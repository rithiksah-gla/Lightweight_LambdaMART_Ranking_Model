# -*- coding: utf-8 -*-
"""RAG_dissertaion.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1HG0EsAt3ZYnifYu9aEx_vxrqOrMaYk32
"""
...
def score_candidate_llm(query_text, query_label, candidate_text, candidate_label, tokenizer, model, device, prompt_prefix):
    ...
    prob_correct = probs[0, query_label].item()
...
for idx, query_ex in tqdm(enumerate(train_data), total=len(train_data)):
    ...
    # Find top 51 neighbors (including self)
...
# 6. Save to CSV and TSV
fieldnames = ['query', 'query_label', 'candidate', 'candidate_label', 'distance', 'score']
csv_file = "train_dataset_lambdamart.csv"
tsv_file = "train_dataset_lambdamart.tsv"
